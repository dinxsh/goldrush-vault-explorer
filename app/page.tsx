...
const PRESETS: { label: string; address: string; chain: SupportedChain }[] = [
    {
    ...
    {
        label: "Euler USDC (Ethereum)",
        address: "0x797DD80692c3b2dAdabCe8e30C07a7d6E32914aa",
        chain: "eth-mainnet",
    },
    {
        label: "Steakhouse USDC (Morpho Base)",
                    ...
                    <div className="flex flex-wrap gap-2">
                        {PRESETS.map((preset) => (
                            <button
                                ...
                                className="rounded border px-3 py-1.5 text-xs font-medium transition-colors hover:border-[var(--accent)] hover:text-[var(--accent)]"
                                style={{
